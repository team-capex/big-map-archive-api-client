...
When backing up a production database, put the `metadata.yaml` file under version control in the [finales-db-backup](https://github.com/materialscloud-org/finales-db-backup) GitHub repository. 
