...
For backing up production databases, do not forget to put your `metadata.yaml` under version control in the [finales-db-backup GitHub repository](https://github.com/materialscloud-org/finales-db-backup). 
