...
When backing up a production database, put the `metadata.yaml` file under version control in the [finales-db-back-up](https://github.com/materialscloud-org/finales-db-back-up) GitHub repository. 
